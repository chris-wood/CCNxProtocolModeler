...
def main():
	...
	# ax1.scatter(x, mu2, s=10, c='r', marker="s")
	# ax1.scatter(x, mu3, s=10, c='b', marker="s")

	# Miss probabilities
	# ax1.scatter(x, n1, s=10, c='g', marker="s")
	# ax1.scatter(x, n2, s=10, c='r', marker="s")
	# ax1.scatter(x, n3, s=10, c='b', marker="s")
